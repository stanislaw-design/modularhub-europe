...
// spec 0031 AC-2, AC-9: sam wzorzec auth co /internal/zapytania.
describe("InternalProduktDetailPage", () => {
  it("redirects to logowanie with the callbackUrl pointing at this exact product when there is no session", async () => {
    authMock.mockResolvedValue(null);

    await expect(renderPage("prod-1")).rejects.toThrow();

    expect(redirectMock).toHaveBeenCalledWith("/pl/logowanie?callbackUrl=%2Fpl%2Finternal%2Fprodukty%2Fprod-1");
  });
