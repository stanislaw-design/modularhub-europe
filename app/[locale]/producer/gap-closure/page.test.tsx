...
describe("DomykanieLukPage (spec 0010)", () => {
  ...
  it("redirects to the map, without nazwa, when kraj is missing (AC-3)", async () => {
    await expect(renderPage({})).rejects.toThrow("NEXT_REDIRECT:/pl/producer/export-readiness");
  });
