...
// Strona główna /producer (spec 0032 AC-10): treść marketingowa z CTA do
...
export default async function ProducentPage({
  ...
  if (session?.user.role === "producer") {
    redirect(`/${locale}/producer/panel`);
  }
      ...
      <Grid gap={4}>
        ...
        <Card padding="lg" className="col-span-12 lg:col-span-5">
          <Stack gap={4} align="start">
            ...
            <Button as="a" href={`/${locale}/producer/registration`} className="w-fit">
              {t("ctaRegister")}
            </Button>
            <Button
              as="a"
