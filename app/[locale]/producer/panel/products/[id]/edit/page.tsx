...
function producerProductToDraft(row: ProducerProductForEdit, variants: ProducerVariantForEdit[]): ProjectDraft {
  ...
  return {
    ...
    deliveryCountries: row.deliveryCountries as ProjectDraft["deliveryCountries"],
    ...
    foundationOptionsEn: row.foundationOptionsEn ?? "",
    foundationOptionsNl: row.foundationOptionsNl ?? "",
    foundationOptionsDe: row.foundationOptionsDe ?? "",
