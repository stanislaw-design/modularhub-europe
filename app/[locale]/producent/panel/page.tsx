...
export default async function ProducerPanelPage({
  ...
  const selfHref = `/${locale}/producent/panel`;
    ...
    <Stack gap={4}>
      ...
      <Stack gap={2}>
        ...
        <Stack direction="row" gap={2} className="flex-wrap">
          <Button as="a" href={`/${locale}/producent/gotowosc-eksportowa`} variant="secondary" size="sm">
            {t("demoExportReadiness")}
          </Button>
          <Button as="a" href={`/${locale}/producent/weryfikacja-firmy`} variant="secondary" size="sm">
