...
// yet, same as today.
export function ProducerShowcase({ producers }: ProducerShowcaseProps) {
  return (
      ...
      <div className="flex flex-col gap-brand-4">
        <div className="flex flex-wrap items-baseline justify-between gap-brand-2">
          <div className="flex flex-col gap-1">
            <Heading level="h2">Zweryfikowani producenci</Heading>
            <Text tone="muted">Każdy producent na platformie przechodzi naszą weryfikację.</Text>
          </div>
          <button
            type="button"
            disabled
