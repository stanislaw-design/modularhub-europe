...
Governing specs: `docs/specs/0003-strona-startowa/`, `0004-wyniki-z-filtrem-prawnym/`, `0005-zapytanie-shortlista/`, `0006-analiza-dzialki-i-dossier/`, `0007-realizacja-os-statusow/`, `0016-katalog-produktow-producenta/` (the local product preview on `wyniki/`).
