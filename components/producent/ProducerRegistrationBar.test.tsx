...
describe("ProducerRegistrationBar", () => {
  it("shows the NIP, the joined country names, and the technology label", () => {
    render(
  ...
  it("shows a single country's name for a single-country registration", () => {
    render(
      <ProducerRegistrationBar
  ...
  it("falls back to the raw country code when it is not in the given countries list", () => {
    render(
      <ProducerRegistrationBar
  ...
  it("shows the confirmation badge text", () => {
    render(
      <ProducerRegistrationBar
