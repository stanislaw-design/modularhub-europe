...
| Plik | Zastosowanie |
|---|---|
| `horizontal/logo-horizontal-primary-v4.svg` | podstawowy nagłówek na jasnym tle |
| `horizontal/logo-horizontal-reversed-v4.svg` | nagłówek na fotografii lub ciemnym tle |
| `horizontal/logo-horizontal-compact-v4.svg` | wąski nagłówek, stopka, dokument |
| `stacked/logo-stacked-primary-v4.svg` | format pionowy i prezentacje |
| `symbol/logo-symbol-primary-v4.svg` | samodzielny znak |
| `symbol/logo-symbol-mono-dark-v4.svg` | druk jednokolorowy na jasnym tle |
