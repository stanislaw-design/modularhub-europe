...
export const eligibility: EligibilityByCountry[] = [
  ...
  // Steel House Studio 38
  {
    projectId: "prj-steelhouse-studio-38",
    countryCode: "PL",
    status: "approved",
    reason: "Zgodne z warunkami technicznymi obowiązującymi w Polsce.",
  },
  ...
  },
  {
    ...
    countryCode: "DE",
    status: "approved",
    reason: "Konstrukcja stalowa z podwyższoną odpornością na obciążenie śniegiem spełnia normy krajów alpejskich Niemiec.",
  },
  {
    projectId: "prj-steelhouse-alpine-104",
    countryCode: "NL",
